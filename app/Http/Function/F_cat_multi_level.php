...
?>
      <tr>
         ...
         <td> 
            ...
            <?php }else{ ?>
               <img src="<?php echo asset('img_webux/noimg.jpg');?>" width="30px">
            <?php } ?>
         </td>
         <td>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="type">
                                    <option value="news" <?php if($val->type == 'news'){echo 'selected';} ?> >Tin tức</option>
                                    <option value="product"<?php if($val->type == 'product'){echo 'selected';} ?>>Sản phẩm</option>
                                    <option value="service"<?php if($val->type == 'service'){echo 'selected';} ?>>Dịch vụ</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="icon" value="<?php echo $val -> icon ?>">
                            </div>
                        </div>
                    </div>
               </div>
