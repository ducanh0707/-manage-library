...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row mt-3">
            <div class="col-md-12">
                <a href="{{asset('admin/comment/content_comment')}}" class="btn btn-primary">Nội dung bình luận</a>
            </div>
        </div>
                        ...
                        <form action="{{asset('admin/comment/action')}}" method="POST">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    {{-- <td class="">
                                        @if($val->img)
                                        <img width="30px" src="{{asset('/source/comment/'.$val->img)}}" />
                                        @else
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{-- xem  --}}
                                        <a target="_blank" href="{{asset($val->f_book-> f_cat -> first()->url.'/'.$val->f_book->url.'.html')}}">Xem</a>
                                    </td>
