                     ...
                     <form action="{{asset('admin/slide/'.$slide_id.'/img')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                           <div class="form-group">
                              ...
                              {{F_input_basic('text',$value = old('title'),'title','','form-control','','')}}
                    
                           </div>
                           @if($slide -> type  == 'video')
                              <div class="form-group">
                                 <label class="font-weight-bold"> Video</label>
                                 {{F_input_textarea('','video','video_new','form-control','','')}}
                              </div>
                           @endif
                           <!-- ảnh slide  -->
                           <div class="form-group">
                              <div class="widget-img">
                                 ...
                                 <div class="">
                                    <label> <i class="fa fa-image"></i> <b>Tải ảnh lên </b></label><br />
                           ...
                           <div class="form-group">
                              ...
                              {{F_input_textarea('','des','des','form-control','','')}}
                  ...
                  @if(count($slide_img) != 0)
                     @foreach($slide_img as $key => $val)
                        <tr>
                           ...
                           <td class=""> 
                              @if($val->img)
                                 <img width="50px" src="{{asset('/source/slide/'.$val->img)}}"  style="background-color: rgb(218, 218, 218)">
                                       ...
                                       <div class="modal-body text-left">
                                          <form action="{{asset('admin/slide/'.$slide_id.'/img/edit/'.$val->id)}}" method="POST" enctype="multipart/form-data">
                                             ...
                                             <div>
                                                <div class="form-group">
                                                   <label class="font-weight-bold"> Tiêu đề ảnh silde</label>
                                                   {{F_input_basic('text',$val-> title,'title','','form-control','','')}}
                                              
                                                </div>
                                                @if($slide -> type  == 'video')
                                                   <div class="form-group">
                                                      <label class="font-weight-bold"> Video</label>
                                                      {{F_input_textarea($val ->video,'video','video'.$val->id,'form-control','','')}}
                                                   </div>
                                                @endif
                                                <!-- ảnh slide  -->
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                   <label class="font-weight-bold"> Mô tả</label>
                                                   {{F_input_textarea($val ->des,'des','des'.$val->id,'form-control','','')}}
