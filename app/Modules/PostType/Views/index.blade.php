                     ...
                     <div class="modal-body text-left">
                           <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <div class="form-check">
                                       <input class="form-check-input" name="feild[]" type="checkbox" id="f_price_month" value="price_month">
                                       <label class="form-check-label" for="f_price_month">Bảng giá</label>
                                    </div>
                                    {{-- <div class="form-check">
                                       <input class="form-check-input" name="feild[]" type="checkbox" id="f_coupon" value="coupon">
                                       <label class="form-check-label" for="f_coupon">Coupon</label>
                                    </div> --}}
                                    <div class="form-check">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <div class="form-check">
                                       <input class="form-check-input" name="feild[]" type="checkbox" id="f_theme" value="theme" >
                                       <label class="form-check-label" for="f_theme">Giao diện</label>
                                    </div>
                                 </div>
                           </div>
                                       ...
                                       <div class="modal-body text-left">
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-md-3">
                                                ...
                                                <div class="form-check">
                                                   <input class="form-check-input" name="feild[]" type="checkbox" id="fe_price_month_{{$val->id}}" value="price_month" @if(is_array(json_decode($val->feild))) @if(in_array('price_month',json_decode($val->feild))) checked @endif @endif>
                                                   <label class="form-check-label" for="fe_price_month_{{$val->id}}">Bảng giá</label>
                                                </div>
                                                {{-- <div class="form-check">
                                                   <input class="form-check-input" name="feild[]" type="checkbox" id="fe_coupon_{{$val->id}}" value="coupon" @if(is_array(json_decode($val->feild))) @if(in_array('coupon',json_decode($val->feild))) checked @endif @endif>
                                                   <label class="form-check-label" for="fe_coupon_{{$val->id}}">Coupon</label>
                                                </div> --}}
                                                <div class="form-check">
                                             ...
                                             <div class="col-md-3">
                                                ...
                                                <div class="form-check">
                                                   <input class="form-check-input" name="feild[]" type="checkbox" id="fe_theme_{{$val->id}}" value="theme" @if(is_array(json_decode($val->feild))) @if(in_array('theme',json_decode($val->feild))) checked @endif @endif>
                                                   <label class="form-check-label" for="fe_theme_{{$val->id}}">Giao diện</label>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="modal-footer">
