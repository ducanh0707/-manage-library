...
@section('content')
@include('Account::Classes/PHPExcel')
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <a class="btn btn-sm btn-primary" href="{{ asset('admin/account')}}">Quay lại</a> Nhập bảng excel liên hệ
		</h1>
		- Bước 1: Xem mẫu <a href="{{asset('source/account/website_data_20220402.xls')}}" target="_blank">tại đây</a> <br>
    ...
    <section class="content">
			...
			<?php
					...
					if(isset($_GET["file"])){
						...
						//Đường dẫn file
						$file = public_path('source/account/'.$_GET["file"]);
			...
			?>
			<form action="{{asset('admin/account/import')}}" method="post" enctype="multipart/form-data">
