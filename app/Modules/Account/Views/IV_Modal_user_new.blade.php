<div class="modal fade" id="new_account" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <form action="{{asset('admin/account/new')}}" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title text-dark" id="exampleModalCenterTitle" >Thêm mới tài khoản</h5>
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="Nhập số tiền" name="money" value="{{old('money')}}">
                 </div>   
                </div>
                <div class="col-md-6">
