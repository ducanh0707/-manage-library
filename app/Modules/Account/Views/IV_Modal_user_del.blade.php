...
<!-- Modal xoa meta -->
<div class="modal fade" id="del_account_{{$val->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
           ...
           <div class="modal-header">
            ...
            <div class="modal-body">
               ...
               <div class="modal-footer">
                  ...
                  <a href="{{asset('admin/account/del/'.$val->id)}}" class="btn btn-sm btn-danger">Ok Xóa</a>
               </div>     
