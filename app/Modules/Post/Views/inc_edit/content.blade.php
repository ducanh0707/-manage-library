    ...
    <div class="form-group">
        ...
        <script>
            tinymce.init({
                ...
                toolbar2: "customInsertButton textAmiSlide textUpload textCol | fontsizeselect| responsivefilemanager | link unlink anchor | image media | forecolor backcolor  | print preview code emoticons | webux_upload",
