   ...
   <div class="box-body">
      <div class="form-group google_snipet" style="padding: 10px; background-color: #f0f0f1; border-radius: 5px;">
        ...
        <div class="form-group">
           ...
           <input id="seo_title" type="text" class="form-control" placeholder="Bạn điền tiêu đề" name="title_seo" value="{{old('title_seo')}}">

        </div>
        <!-- mô tả bài viết  -->
        <div class="form-group">
           <label>Mô tả bài viết (Số lượng tiêu chuẩn 215 ký tự | hiện tại : <span id="count_des"></span>)</label>
           <textarea id="seo_des" class="form-control" rows="3" name="des_seo" placeholder="Bạn điền mô tả bài viết">{{old('des_seo')}}</textarea>
        </div>
        <!-- meta keyword bài viết  -->
        <div class="form-group">
           <label>Keywords (SEO - Meta keyword)</label>
           <input type="text"  class="form-control" rows="3" name="key_seo" placeholder="Bạn điền từ khóa bài viết, cách nhau dấu phẩy" value="{{ old('key_seo') }}">
        </div>
        <!-- index-->
        <div class="form-group">
