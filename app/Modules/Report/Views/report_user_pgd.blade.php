                                ...
                                @if(count($user_list) != 0)
                                    @foreach($user_list as $key => $val)
                                        <tr>
                                            ...
                                            <td class="">
                                               <?php 
                                                    $user =  App\Http\Model\User::where('user_type_id',35)->where('huyen_id',$val->huyen_id)->get()->count();
                                                    echo  $user;
                                               ?>
                                            </td>
                                             ...
                                             <td class="">
                                                <?php 
                                                    $price =  App\Http\Model\M_ke_toan::where('tinh_id',$val->tinh_id)->where('huyen_id',$val->huyen_id)->where('type','service')->get();
                                                    if(count($price)>0){
