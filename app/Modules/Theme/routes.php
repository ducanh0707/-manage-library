...
Route::group(['prefix'=>'admin','middleware' => ['web', 'checkAdminLogin']], function(){
   Route::group(['prefix'=>'theme'], function(){
         ...
         //theme
         Route::post('new', 'App\Modules\Theme\Controllers\ThemeController@post_theme_new');
         Route::get('del/{theme_id}', 'App\Modules\Theme\Controllers\ThemeController@get_theme_del');
         // row 
         Route::post('{theme_id}/row_order', 'App\Modules\Theme\Controllers\ThemeController@post_theme_row_order');
         Route::post('{theme_id}/row_new', 'App\Modules\Theme\Controllers\ThemeController@post_theme_row_new');
         Route::group(['prefix'=>'{theme_id}/row'], function(){
